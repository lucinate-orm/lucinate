...
export type VineDbSearchOptions<ValueType> = {
     ...
     */
    filter?: (db: DatabaseQueryBuilderContract, value: ValueType, field: VineFieldContext) => void | Promise<void>;
};
/**
 * Callback to self execute the query for the unique and the
 * exists validations
 */
export type VineDbSearchCallback<ValueType> = (db: Database, value: ValueType, field: VineFieldContext) => Promise<boolean>;
