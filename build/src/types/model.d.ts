...
export interface ModelQueryBuilderContract<Model extends LucidModel, Result = InstanceType<Model>> extends ChainableContract, ExcutableQueryBuilderContract<Result[]> {
     ...
     * Implemented on `ModelQueryBuilder`; relation query builders inherit a no-op stub.
     */
    joinRelation(relationName: string, options?: {
        joinType?: 'inner' | 'left';
     ...
     * Implemented on `ModelQueryBuilder`; relation query builders inherit a no-op stub.
     */
    leftJoinRelation(relationName: string, options?: {
        joinType?: 'inner' | 'left';
        selectRelated?: boolean;
    }): this;
    /**
     ...
     */
    selectRelated(path: string, options?: {
        joinType?: 'inner' | 'left';
        sideload?: boolean;
        columns?: '*' | string[];
    }): this;
...
export interface LucidRow {
     ...
     * Load aggregates
     */
    loadAggregate: <Self extends this, Name extends ExtractModelRelations<Self>, RelatedBuilder = NonNullable<Self[Name]> extends ModelRelations<LucidModel, LucidModel> ? NonNullable<Self[Name]>['__relationSubQuery'] : never>(name: Name, callback: (builder: RelatedBuilder) => void) => LazyLoadAggregatesContract<Self>;
    /**
     * Load count
     */
    loadCount: <Self extends this, Name extends ExtractModelRelations<Self>, RelatedBuilder = NonNullable<Self[Name]> extends ModelRelations<LucidModel, LucidModel> ? NonNullable<Self[Name]>['__relationSubQuery'] : never>(name: Name, callback?: (builder: RelatedBuilder) => void) => LazyLoadAggregatesContract<Self>;
    /**
     ...
     */
    related<Name extends ExtractModelRelations<this>>(relation: Name): NonNullable<this[Name]> extends ModelRelations<LucidModel, LucidModel> ? NonNullable<this[Name]>['__relationClient'] : never;
}
/**
 * ------------------------------------------------------
...
export interface LucidModel {
     ...
     */
    $getRelation<Model extends LucidModel, Name extends ExtractModelRelations<InstanceType<Model>>>(this: Model, name: Name): NonNullable<InstanceType<Model>[Name]> extends ModelRelations<LucidModel, LucidModel> ? NonNullable<InstanceType<Model>[Name]>['__relationClient'] extends {
        relation: infer Relation;
    } ? Relation : RelationshipsContract : RelationshipsContract;
     ...
     */
    filter<Model extends LucidModel, Result = InstanceType<Model>>(this: Model, input?: ModelObject, FilterCtor?: any): ModelQueryBuilderContract<Model, Result>;
    /**
