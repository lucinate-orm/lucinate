 ...
 */
export type GetRelationModelInstance<Relation extends ModelRelations<LucidModel, LucidModel>> = Relation['__opaque_type'] extends 'hasOne' | 'belongsTo' | 'morphTo' | 'morphOne' ? Relation['__relationInstance'] : Relation['__relationInstance'][];
/**
 * ------------------------------------------------------
 * Options
 * ------------------------------------------------------
...
export type ModelRelationTypes = {
    readonly __opaque_type: 'hasOne' | 'hasMany' | 'belongsTo' | 'manyToMany' | 'hasManyThrough' | 'morphTo' | 'morphOne' | 'morphMany';
};
/**
...
export type BelongsTo<RelatedModel extends LucidModel, ParentModel extends LucidModel = LucidModel> = InstanceType<RelatedModel> & {
    ...
    __relationModel: RelatedModel;
    __relationInstance: InstanceType<RelatedModel>;
    __relationClient: BelongsToClientContract<BelongsToRelationContract<ParentModel, RelatedModel>, RelatedModel>;
    __relationBuilder: RelationQueryBuilderContract<RelatedModel, any>;
    __relationSubQuery: RelationSubQueryBuilderContract<RelatedModel>;
};
/**
...
export type ManyToMany<RelatedModel extends LucidModel, ParentModel extends LucidModel = LucidModel> = InstanceType<RelatedModel>[] & {
    ...
    __relationModel: RelatedModel;
    __relationInstance: InstanceType<RelatedModel>;
    __relationClient: ManyToManyClientContract<ManyToManyRelationContract<ParentModel, RelatedModel>, RelatedModel>;
...
export type HasManyThrough<RelatedModel extends LucidModel, ParentModel extends LucidModel = LucidModel> = InstanceType<RelatedModel>[] & {
    ...
    __relationModel: RelatedModel;
    __relationInstance: InstanceType<RelatedModel>;
    __relationClient: HasManyThroughClientContract<HasManyThroughRelationContract<ParentModel, RelatedModel>, RelatedModel>;
 ...
 */
export type MorphTo<RelatedModel extends LucidModel, ParentModel extends LucidModel = LucidModel> = InstanceType<RelatedModel> & {
 ...
 */
export type MorphOne<RelatedModel extends LucidModel, ParentModel extends LucidModel = LucidModel> = InstanceType<RelatedModel> & {
 ...
 */
export type MorphMany<RelatedModel extends LucidModel, ParentModel extends LucidModel = LucidModel> = InstanceType<RelatedModel>[] & {
 ...
 * properties.
 */
export type ModelRelations<RelatedModel extends LucidModel, ParentModel extends LucidModel = LucidModel> = HasOne<RelatedModel, ParentModel> | HasMany<RelatedModel, ParentModel> | BelongsTo<RelatedModel, ParentModel> | ManyToMany<RelatedModel, ParentModel> | HasManyThrough<RelatedModel, ParentModel> | MorphTo<RelatedModel, ParentModel> | MorphOne<RelatedModel, ParentModel> | MorphMany<RelatedModel, ParentModel>;
/**
 * ------------------------------------------------------
 * Relationships
 * ------------------------------------------------------
 ...
 */
export interface MorphToClientContract<RelatedModel extends LucidModel, ParentModel extends LucidModel = LucidModel> {
    query<Result = InstanceType<RelatedModel>>(): RelationQueryBuilderContract<RelatedModel, Result> | null;
    associate(related: InstanceType<RelatedModel>): Promise<void>;
    dissociate(): Promise<void>;
}
/**
...
export interface WithCount<Model extends LucidRow, Builder> {
    <Name extends ExtractModelRelations<Model>, RelatedBuilder = NonNullable<Model[Name]> extends ModelRelations<LucidModel, LucidModel> ? NonNullable<Model[Name]>['__relationSubQuery'] : never>(relation: Name, callback?: (builder: RelatedBuilder) => void): Builder;
}
/**
...
export interface WhereHas<Model extends LucidRow, Builder> {
    <Name extends ExtractModelRelations<Model>, RelatedBuilder = NonNullable<Model[Name]> extends ModelRelations<LucidModel, LucidModel> ? NonNullable<Model[Name]>['__relationSubQuery'] : never>(relation: Name, callback: (builder: RelatedBuilder) => void, operator?: string, value?: StrictValues | ChainableContract): Builder;
}
/**
 * ------------------------------------------------------
 * Preloader
...
export interface Preload<Model extends LucidRow, Builder> {
    <Name extends ExtractModelRelations<Model>, RelatedBuilder = NonNullable<Model[Name]> extends ModelRelations<LucidModel, LucidModel> ? NonNullable<Model[Name]>['__relationBuilder'] : never>(relation: Name, callback?: (builder: RelatedBuilder) => void): Builder;
}
