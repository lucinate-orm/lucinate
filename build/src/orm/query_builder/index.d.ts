...
import { type LucidRow, type LucidModel, type ModelObject, type ModelAdapterOptions, type ModelQueryBuilderContract } from '../../types/model.js';
import { type PreloaderContract, type RelationshipsContract } from '../../types/relations.js';
import { type DialectContract, type QueryClientContract, type TransactionClientContract } from '../../types/database.js';
...
export declare class ModelQueryBuilder extends Chainable implements ModelQueryBuilderContract<LucidModel, LucidRow> {
     ...
     */
    sideload(value: ModelObject, merge?: boolean): this;
    /**
     ...
     */
    joinRelation(_relationName: string, _options?: {
        joinType?: 'inner' | 'left';
     ...
     * Join-relations addon: no-op stub; replaced by macro when the addon is loaded.
     */
    leftJoinRelation(_relationName: string, _options?: {
        joinType?: 'inner' | 'left';
        selectRelated?: boolean;
    }): this;
    /**
     ...
     */
    selectRelated(_path: string, _options?: {
        joinType?: 'inner' | 'left';
        sideload?: boolean;
        columns?: '*' | string[];
    }): this;
