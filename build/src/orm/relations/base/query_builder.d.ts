...
import { type LucidRow, type LucidModel, type ModelQueryBuilderContract } from '../../../types/model.js';
import { type RelationshipsContract, type RelationQueryBuilderContract } from '../../../types/relations.js';
...
export declare abstract class BaseQueryBuilder extends ModelQueryBuilder implements RelationQueryBuilderContract<LucidModel, LucidRow> {
     ...
     * Return knex query
     */
    toKnex(): Knex.QueryBuilder<any, any>;
    /**
     * Get query sql
     */
    toSQL(): Knex.Sql;
