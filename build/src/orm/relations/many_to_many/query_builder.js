...
export class ManyToManyQueryBuilder extends BaseQueryBuilder {
    ...
    getGroupLimitQuery() {
        ...
        const rowName = 'lucinate_group_limit_counter';
        /**
        ...
        this.select(this.client.raw(`row_number() over (PARTITION BY ?? ORDER BY ?? ${direction}) as ${rowName}`, [this.pivotHelpers.prefixPivotTable(this.relation.pivotForeignKey), column])).as('lucinate_temp');
