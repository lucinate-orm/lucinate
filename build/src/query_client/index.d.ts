...
import { type ConnectionConfig, type IsolationLevels, type DialectContract, type ConnectionContract, type QueryClientContract, type TransactionClientContract, type ColumnInfo } from '../types/database.js';
 ...
 */
export declare function resolveDebugFromConnectionConfig(config: ConnectionConfig): boolean;
/**
 ...
 */
export declare function pickConnectionDebug(poolConfig: ConnectionConfig | undefined, connectionConfig: ConnectionConfig, databaseGlobal?: boolean): boolean;
/**
...
export declare class QueryClient implements QueryClientContract {
     ...
     */
    debug: boolean;
    constructor(mode: 'dual' | 'write' | 'read', connection: ConnectionContract, emitter: Emitter<any>, debug: boolean);
    /**
