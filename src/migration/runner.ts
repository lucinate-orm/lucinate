...
export class MigrationRunner extends EventEmitter {
   ...
   */
  private normalizeMigrationName(name: string) {
  ...
  private async makeMigrationsTable() {
    ...
    await this.client.schema.createTable(this.schemaTableName, (table: Knex.CreateTableBuilder) => {
  ...
  private async makeMigrationsVersionsTable() {
    ...
    await this.client.schema.createTable(this.schemaVersionsTableName, (table: Knex.CreateTableBuilder) => {
   ...
   */
  private async upgradeFromTwoToThree() {
  ...
  private isSquashedMigration(name: string) {
    ...
    return (
      this.schemaDumpManifest.hasSquashedMigration(name) ||
