...
function extrasKey(key: PropertyKey): string | null {
...
export const proxyHandler = {
  get(target: any, key: any, receiver: any) {
    ...
    /**
     * Extras (aggregates, raw selects, etc.): same value as $extras[key],
     * Laravel-style direct access without duplicating storage.
     */
    const extraKey = extrasKey(key)
    if (extraKey !== null && Object.prototype.hasOwnProperty.call(target.$extras, extraKey)) {
      return target.$extras[extraKey]
    }
  ...
  set(target: any, key: any, value: any, receiver: any) {
    ...
    const extraKey = extrasKey(key)
    if (extraKey !== null && INTERNAL_INSTANCE_PROPERTIES.has(extraKey)) {
      return Reflect.set(target, key, value, receiver)
    }

    if (extraKey !== null && Object.prototype.hasOwnProperty.call(target.$extras, extraKey)) {
      target.$extras[extraKey] = value
      return true
    }
