...
export class ManyToManyQueryClient implements ManyToManyClientContract<ManyToMany, LucidModel> {
   ...
   */
  static query(client: QueryClientContract, relation: ManyToMany, rows: OneOrMany<LucidRow>) {
   ...
   */
  static eagerQuery(client: QueryClientContract, relation: ManyToMany, rows: OneOrMany<LucidRow>) {
    const query = new ManyToManyQueryBuilder(client.knexQuery(), client, rows, relation)
   ...
   */
  static subQuery(client: QueryClientContract, relation: ManyToMany) {
   ...
   */
  static pivotQuery(client: QueryClientContract, relation: ManyToMany, rows: OneOrMany<LucidRow>) {
    const query = new ManyToManyQueryBuilder(client.knexQuery(), client, rows, relation)
   ...
   */
  async detach(ids?: (string | number)[], trx?: TransactionClientContract) {
